...
export const WorkerOnboarding = ({ username }: { username?: string }) => {
  ...
  const lead = username
    ...
    : "moneymaxxxing — это закрытая площадка, где воркеры приводят рекламодателей блогерам. Вы зарабатываете с каждой согласованной интеграции, мы берём на себя контракты, расчёты и выплаты.";
