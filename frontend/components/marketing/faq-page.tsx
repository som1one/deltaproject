...
const faqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "moneymaxxxing — сообщество и кабинеты тех, кто зарабатывает: воркеров и блогеров. Маркетплейс — отдельный сервис для заказчиков: каталог блогеров, где покупают рекламу. Воркеры приводят туда заказчиков, блогеры выполняют там заказы.",
  },
  {
